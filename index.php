...
<body>
    <header>
        <div class="header__container">
            ...
            <div class="menu header__menu">
                ...
                <a class="menu__item" href="pizzas.php">Пицца</a>
    ...
    <div class="wow animate__zoomIn" id="order">
            ...
            <div id="order-form">
                <form id="form" action="">
                    ...
                    <div>
                        ...
                        <div class="error-input">Необходимо ввести адресс доставки</div>
                    </div>
                    <div>
                    ...
                    <div>
                        <button id="submit" class="submit hvr-shrink" type="button">Оформить заказ</button>
                    </div>
                </form>
                <div id="hidden-result">
                    <h2>Спасибо за Ваш заказ. Мы скоро свяжемся с Вами!</h2>
                </div>
            </div>
            <div id="order-image">
    ...
    <div id="cookie">
        <div id="cookie-title">
            <div>Мы используем файлы Cookie</div>
            <span class="cookie-close">&times;</span>
        </div>
        <div id="cookie-text">
            Для корректной работы сайта мы используем Cookie файлы
        </div>
        <div id="cookie-button">
            <button  class="btn cookie-close">Принять</button>
        </div>
    </div>
